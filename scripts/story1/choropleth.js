...
slider.addEventListener("input", function() {
    ...
    d3.select("#barchart_svg_0").remove();
    d3.select("#barchart_svg_1").remove();
    d3.select("#barchart_svg_2").remove();
    d3.select("#barchart_svg_3").remove();
    d3.select("#barchart_svg_4").remove();
    d3.select("#barchart_svg_5").remove();
